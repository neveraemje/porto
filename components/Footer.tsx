...
const Footer = () => {
  return (
    <div className=" max-w-3xl mx-auto border-t mt-14 border-zinc-200 dark:border-zinc-700">
      ...
      <div className='flex flex-col items-center mt-14 mb-40'>

        <h3 className='mb-2 dark:text-zinc-400 text-zinc-600 tracking-tight'>Get in touch to collaborate.</h3>
        ...
        <div className="mt-6 flex gap-6">
          <a className="group -m-1 p-1" aria-label="Follow on Instagram" href="https://www.instagram.com/neveraemje/">
          ...
          <a className="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/neveraemje">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
          ...
          <a className="group -m-1 p-1" aria-label="Follow on LinkedIn" href="https://www.linkedin.com/in/neveraemje/">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
